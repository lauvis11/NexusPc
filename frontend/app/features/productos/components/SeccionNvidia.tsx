...
export function SeccionNvidia({ onAddToCart }: SeccionNvidiaProps) {
  return (
    <section className="w-full py-12 lg:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      {/* Contenedor principal con imagen de fondo hero1.png */}
      <div className="relative overflow-hidden rounded-3xl border border-border/60 shadow-2xl bg-slate-900">
        {/* Imagen de fondo / Banners hero1 */}
        <div
          className="absolute inset-0 bg-cover bg-center opacity-100"
          style={{ backgroundImage: "url('/banners/hero1.png')" }}
        ></div>

        {/* Capa de gradiente ligera en lado izquierdo para legibilidad */}
        ...
        <div className="relative z-10 p-8 sm:p-12 lg:p-14 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5 text-surface space-y-7">
            <h2 className="text-3xl sm:text-5xl font-black text-white tracking-tight leading-tight pt-2">
              Descubrí lo mejor de <span className="text-emerald-400">NVIDIA</span>
            </h2>

            <p className="text-base sm:text-lg text-slate-300 font-normal leading-relaxed max-w-md">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-xl bg-emerald-500 text-slate-950 font-bold text-sm hover:bg-emerald-400 active:scale-95 transition-all shadow-lg shadow-emerald-500/25"
            >
          ...
          {/* Columna Derecha: Reutilizando ProductoCard */}
